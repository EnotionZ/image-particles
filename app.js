(function() {
    ...
    function loadScene() {
        ...
        gl.shaderSource(vertexShader, VERTEX_SHADER_SCRIPT);
    ...
    function drawScene() {
        ...
        for(i = 0; i < numLines; i+=2) {
            ...
            if(t.touched) {
                var dx = t.touchX - vertices[bp],
                    dy = t.touchY - vertices[bp+1],
